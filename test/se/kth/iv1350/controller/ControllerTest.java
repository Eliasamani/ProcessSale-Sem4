...
class ControllerTest {
    ...
    void testEnterIdentifierInvalidItem() throws DatabaseFailureException {
        ...
        fail("IdentifierNotFoundException expected but was not thrown.");
        assertEquals(0, controller.getSaleInformation().getCart().size(), "Sale should have "
        		+ "zero items after adding an invalid item ID");
